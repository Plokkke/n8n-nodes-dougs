...
import { handler as validateHandler, operation as validateOperation, setup as validateSetup } from './validate';
import { handler as deleteHandler, operation as deleteOperation, setup as deleteSetup } from './delete';
